...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Arshad Hanif — Oracle Fusion consultant, ACCA, and finance professional. The story and credentials behind MyVault.',
  openGraph: {
    title: 'About',
    description:
      'Arshad Hanif — Oracle Fusion consultant, ACCA, and finance professional behind MyVault.',
  },
};
