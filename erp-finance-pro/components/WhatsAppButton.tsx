...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-lg transition-all duration-200 hover:bg-[#20BD5A] hover:shadow-xl sm:bottom-8 sm:right-8"
    >
      {/* WhatsApp icon */}
      <svg
