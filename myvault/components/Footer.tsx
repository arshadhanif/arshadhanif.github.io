...
const socialClass =
  'grid h-11 w-11 place-items-center rounded-lg border border-border text-muted transition-all hover:-translate-y-0.5 hover:border-accent hover:bg-accent hover:text-background';
      ...
      <div className="container-page py-12">
        <div className="grid gap-10 md:grid-cols-[1.2fr_2fr]">
          ...
          <div>
            ...
            <nav className="mt-4 grid grid-cols-2 gap-x-6 gap-y-2.5 sm:grid-cols-3">
